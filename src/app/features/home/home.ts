      ...
      <div class="space-y-4">
        <div>
          ...
          <div class="relative group">
            ...
            <input id="bookTitle" type="text" [(ngModel)]="bookTitle" placeholder="Ví dụ: A Brief History of Time" 
        ...
        <div>
          ...
          <div class="relative group">
            ...
            <input id="author" type="text" [(ngModel)]="author" placeholder="Ví dụ: Stephen Hawking (hoặc Vô danh)" 
                   (keydown.enter)="canCreate() && createProject()"
                   class="w-full pl-11 pr-4 py-3 border border-zinc-300 rounded-xl focus:ring-0 focus:border-indigo-600 focus:border-2 outline-none text-lg transition-all">
          </div>
        </div>
