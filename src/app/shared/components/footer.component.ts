  ...
  template: `
    <footer class="shrink-0 bg-white border-t border-zinc-200 py-2.5 px-6 text-xs text-zinc-500 flex flex-col sm:flex-row justify-between items-center gap-y-2">
      ...
      <div class="flex items-center flex-wrap justify-center gap-x-2 gap-y-1">
        <span class="font-medium text-zinc-600">v1.0.30</span>
        <span class="text-zinc-300">•</span>
        <a href="https://github.com/kiencang/1987-Layout" target="_blank" rel="noopener noreferrer" class="hover:text-indigo-600 transition-colors">GitHub</a>
        <span class="text-zinc-300">•</span>
        <span class="font-medium">Nguyễn Đức Anh</span>
        <span class="text-zinc-300">•</span>
        <span>contact&#64;wpsila.com</span>
        <span class="text-zinc-300">•</span>
        <a href="https://github.com/kiencang/1987-Layout/blob/main/README.md" target="_blank" rel="noopener noreferrer" class="hover:text-indigo-600 transition-colors">Hướng dẫn dùng</a>
      </div>
    </footer>
  `
})
